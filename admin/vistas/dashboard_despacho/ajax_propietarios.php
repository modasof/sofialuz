...
<div class="clearfix">
          ...
          <table id="tablepropietarios" class="table  table-responsive table-striped table-bordered table-hover" style="width: 100%;font-size: 14px;">
        ...
        buttons: [
            {
                ...
                pageSize: 'LEGAL',
                title:'Informe Combustible Propietario <?php echo($getnompropietario); ?>',
            },
            { extend: 'excelHtml5', title: 'Informe Combustible Propietario <?php echo($getnompropietario); ?>' },
            //'copyHtml5',
            //'excelHtml5',
            //'csvHtml5',
            //'pdfHtml5',
