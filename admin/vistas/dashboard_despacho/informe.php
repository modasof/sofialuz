...
include_once 'modelos/dashboards.php';
include_once 'controladores/dashboardsController.php';
...
//
    ...
    ?>
  <td><strong><a href="?controller=dashboards&&action=despacho&daterange=<?php echo ($fechaconsulta); ?>"><i class="fa fa-line-chart"> </i> <?php echo (ucfirst($monthName)); ?></a></strong></td>
  <td>
    <?php
$ventames17 = Informe_Despachosmesgeneral($i, $anoactual);
    $sumaventas17 += $ventames17;
    echo ("<a style='color:black;' href='?controller=reportes&&action=despachosclientes&daterange=" . $fechaconsulta . "'><small style='color:#128a2e;'></small> " . round($ventames17, 0) . " </a>");
    ?>
  </td>
  <td>
    <?php
$arreglof   = (Informe_EstadisticasDespachos($i, $anoactual));
  ...
  <td>
    <?php
$ventames16 = Informe_Despachosmesgeneralvalor($i, $anoactual);
    $sumaventas16 += $ventames16;
    echo ("<a style='color:black;' href='?controller=reportes&&action=despachosclientes&daterange=" . $fechaconsulta . "'><small style='color:#128a2e;'></small>$ " . number_format($ventames16, 0) . " </a>");
...
<div class="col-md-12">
    <form action="?controller=dashboards&&action=despacho" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
<div class="col-md-12">
 ...
 <?php
if ($getconmes == "ma") {
    $colorbloque = ("<div class='small-box bg-orange'>");
} else {
...
<?php
$bloque1 = Informe_Despachosmesgeneralvalor($mesactual, $anoactual);
...
<a style="color: black;" href="?controller=dashboards&&action=despacho&&daterange=<?php echo ($daterangemesactual); ?>&&conmes=ma" class="small-box-footer">
...
<h4><i class="fa fa-calendar"> </i><strong>
<?php
$bloque2 = Informe_Despachosmesgeneralvalor($mesanterior, $anoactual);
echo ("$".number_format($bloque2, 0));
?>
</strong></h4>
<p><?php echo ($nominforme); ?></p>
</div>

<a style="color: black;" href="?controller=dashboards&&action=despacho&&daterange=<?php echo ($daterangemesanterior); ?>&&conmes=ant" class="small-box-footer">
...
<h4><i class="fa fa-calendar"> </i><strong>
<?php
$bloque3       = Informe_Despachosmesgeneralvalor($trimestre, $anoactual);
$sumatrimestre = $bloque1 + $bloque2 + $bloque3;
echo ("$".number_format($sumatrimestre, 0));
?>
</strong></h4>
<p><?php echo ($nominforme); ?></p>
</div>

<a style="color: black;" href="?controller=dashboards&&action=despacho&&daterange=<?php echo ($daterangetrimestre); ?>&&conmes=tri" class="small-box-footer">
...
<?php
$fechapersonalizada = Informe_Despachosfechageneralvalor($FechaStart, $FechaEnd);
echo ("$".number_format($fechapersonalizada, 0));
?>
...
// Incio Tercera Gráfica
  ...
  var stockChart3 = new CanvasJS.StockChart("chartContainer", {
    ...
    <?php
$res    = Dashboards::GraficaHistorialDespachofecha($FechaStart, $FechaEnd);
