...
<?php 
$img = 'https://sofialuz.net/Login/logo-ppal.png';
        ...
        buttons: [
            {
                ...
                pageSize: 'LEGAL',
                title:'Informe Combustible Equipo <?php echo($nomequipo); ?>',
            },
            { extend: 'excelHtml5', title: 'Informe Combustible Equipo <?php echo($nomequipo); ?>' },
            //'copyHtml5',
            //'excelHtml5',
            //'csvHtml5',
            //'pdfHtml5',
