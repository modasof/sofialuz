...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Informe Fletes Externos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
if ($RolSesion != 4) {
    ?>
  <form action="?controller=reportes&&action=mesfletesexternos" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
if ($fechaform != "") {
    ...
    $res    = Reportes::ReporteVolquetasporfechameseqexternos($FechaStart, $FechaEnd);
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
            <td><a target="_blank" href="?controller=equipos&&action=hojavida&&id=<?php echo($equipo_id_equipo) ?>&&get_mesactual=<?php echo($mesactual) ?>"><?php echo ($nomequipo) ?></a><br><small>
