...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Informe Horas Máquina <small>(Externos)</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
if ($RolSesion != 4) {
    ?>
        <form action="?controller=reportes&&action=meshorasmqexternos" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
?>
  ...
  <tr>
       ...
       <tbody>
        ...
        <?php
if ($fechaform != "") {
    $res    = Reportes::ReporteHorasmqporfechameseqexternos($FechaStart, $FechaEnd);
...
foreach ($campos as $campo) {
    ...
    $idpropietario       = Equipos::obtenerPropietarioEquipo($equipo);
    ...
    ?>
              <tr>
            <td>
                <a target="_blank" href="?controller=equipos&&action=hojavida&&id=<?php echo ($equipo) ?>&&get_mesactual=<?php echo ($mesactual) ?>"><?php echo ($nomequipo) ?></a>
                <br>
                <small>
                    <?php echo ($nompropietario); ?>
                </small>
            </td>
