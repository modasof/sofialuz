  ...
  <div class="content">
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Crear Nuevo Valor Horas Máquina 
            ...
            <!-- /.box-header -->
            <div class="box-body">
    <form role="form" autocomplete="off" action="?controller=clientesprecios&&action=guardarvalorhora&id_cliente=<?php echo($ClienteSel); ?>" method="POST" enctype="multipart/form-data" >
                            <?php  
                ...
                <input type="hidden" name="canal_venta" value="Alquiler Equipos">
                                    ...
                                    <div style="display: none;" class="col-md-3">
                                     ...
                                     <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required  type="text" name="valor_horamq" placeholder="Valor Hora" class="form-control" id="demo3">
                                                </div>
                                    </div>
    ...
    <div class="card card-default">
      ...
      <div class="clearfix">
          ...
          <tbody>
            ...
            $valor_horamq = $campo['valor_horamq'];
            ...
            <tr>
              ...
              <td><?php Echo utf8_encode("$".number_format($valor_horamq));  ?></td>
              ...
              <button  type="button" class="btn btn-default btn-flat"> <a href="#" onclick="eliminarhora(<?php echo $id; ?>,<?php echo($ClienteSel) ?>);" class="tooltip-primary text-danger" title="Eliminar Ruta">
...
<script>
function eliminarhora(idegreso,$ClienteSel){
   eliminar=confirm("¿Deseas eliminar este registro?");
   if (eliminar)
window.location.href="?controller=clientesprecios&&action=eliminarhora&&id="+idegreso+"&&id_cliente="+$ClienteSel+"";
else
