...
//echo ($fechaformateada);
    $validacionregistro = Cargamasiva::validarRegistrohoras($id_equipo,$fechaformateada);

        if ($validacionregistro>0) {
             $actualizarGPS= Cargamasiva::actualizardataGpshoras($fechaformateada,$id_equipo,$totalkm);
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
             <li class="breadcrumb-item"><a href="?controller=horasmq&&action=horas">Reporte Horas</a></li>
...
<div class="col-md-12">
          ...
          <div class="box box-success ">
            <div class="box-header with-border">
              <h3 class="box-title">Carga Masiva Horas Equipos </h3>
