      ...
      <div class="clearfix">
          ...
          <thead>
            ...
            else
            {
              ...
              <td><?php echo utf8_encode($valor_unidad); ?> %</td>
              <td><?php echo utf8_encode($tipo_equipo); ?></td>
               <td><?php echo utf8_encode($marca_equipo); ?></td>
               <td><?php echo utf8_encode(round(ConsumoGalonespor($id_equipo),1)); ?></td>
              <td><?php echo utf8_encode(round(ReporteHorasKmpor($id_equipo),1)); ?></td>
               <td><?php echo utf8_encode(round($consumointernoreportado,1)); ?></td>
