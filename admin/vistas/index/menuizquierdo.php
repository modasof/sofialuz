  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="?controller=gastos&&action=totalegresos"><i class="fa fa-circle-o"></i>Consolidado</a></li>
             <li><a href="?controller=gastos&&action=totalegresoslegal"><i class="fa fa-circle-o"></i>Total Contabilizados</a></li>
            <?php } ?>
          </ul>
        </li>
         <li class="treeview">
      ...
      <li><a href="?controller=gestiondocumentaleq&&action=listaequipos"><i class="fa fa-circle-o"></i> Gestión Documental</a></li>
        <?php } ?>
        <?php if ($m_campamentos=="Si") { ?>
       <li class=""><a href="?controller=campamento&&action=todos"><i class="fa fa-circle-o"></i>Campamentos</a></li>
        <?php } ?>
    ...
    <li class=""><a href="?controller=requisiciones&&action=cotizaciones"><i class="fa fa-shopping-cart"></i>Cotizaciones</a></li>
       ...
       <?php if ($m_categoriains=="Si") { ?>
          ...
          <?php if ($RolSesion==1 or $RolSesion==13) { ?>
            ...
            <li class=""><a href="?controller=requisiciones&&action=todosmiusuario&&id=<?php echo($IdSesion); ?>"><i class="fa fa-check-circle"></i>Mis Requisiciones</a></li>

           <li class=""><a href="?controller=estadosreq&&action=todos"><i class="fa fa-check-circle"></i>Estado Requisiciones</a></li>
      ...
      <?php } ?>      
          ...
          <ul class="treeview-menu">
       <?php if ($m_comprainsumos=="Si") { ?>
           <li class=""><a href="?controller=index&&action=dashboardalmacen"><i class="fa fa-list"></i> Dashboar Almacén</a></li>
