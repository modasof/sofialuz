 ...
 ?>
  <div class="content-wrapper">
    ...
    <div class="col-sm-12 col-xs-12">
     <a style="display: none;" href="?controller=equipos&&action=ordentrabajo&&operador=<?php echo($IdSesion); ?>">
       ...
       <a href="?controller=equipos&&action=ordentrabajoter&&operador=<?php echo($IdSesion); ?>">
        <div class="col-md-3  col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-default"><i class="fa fa-clock-o"></i></span>
            <div class="info-box-content">
              <span class="info-box-text">Mis </span>
              <span class="info-box-number">Ordenes Trabajo</span><br>
              <span class="info-box-number">Terminadas</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
?>
    ...
    <div class="card card-default">
      ...
      <div class="clearfix">
          ...
          <tbody>
            <?php
$res         = Equipos::obtenerPaginareportesusuario($IdSesion);
