...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Ordenes de Trabajo <?php echo utf8_decode($nomusuario) ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
function eliminar($id,$equipo){
   ...
   if (eliminar)
     window.location.href="?controller=equipos&&action=eliminareporte&&id="+$id+"&&id_equipo="+$equipo+"&&usermecanico=0";
else
