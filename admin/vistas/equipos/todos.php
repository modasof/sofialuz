...
foreach ($campos as $campo) {
    ...
    if ($tipo_equipo == "Maquinaria Pesada") {
        $totalreporte = round(ReporteHoraspor($id_equipo), 1);
    } elseif ($tipo_equipo == "Volqueta") {
        $totalreporte = round(ReporteKilometrospor($id_equipo), 1);
    ...
    ?>
            <tr>
              ...
              <td><?php echo utf8_encode($inicial); ?></td>
              <td><?php echo utf8_encode(round($totalreporte, 1)); ?></td>
              <td><?php echo utf8_encode(round($odometroactual, 1)); ?></td>
              ...
              <td>
                ...
                <i class="fa fa-wrench bigger-110 ">Ordenes de Trabajo</i>
              </a>
                          </li>
                          <li>
