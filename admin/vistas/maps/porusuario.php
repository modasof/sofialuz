...
$getconductor= $_GET['id'];

$getnomconductor = Usuarios::obtenerNombreUsuario($getconductor);
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">GPS Conductor <?php echo($getnomconductor); ?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
 ...
 <div class="col-md-12">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="?controller=maps&&action=disponibles">Ver Disponibles</a></li>
             <li class="breadcrumb-item active"><a href="?controller=maps&&action=ocupados">Ver Ocupados</a></li>
          </ol>
        </div><!-- /.col -->
...
function initMap() {
  const uluru = { lat: <?php echo($latitud); ?>, lng: <?php echo($longitud); ?> };
  const map = new google.maps.Map(document.getElementById("map-container-google-2"), {
    zoom: 18,
    center: uluru,
  });

  var persona = '<?php echo($nomusuario); ?>';
  var estado_usuario = '<?php echo($labelestado); ?>';
  var horareporte = '<?php echo($marca_temporal); ?>';

   if (estado_usuario=="Disponible"){
                        var image = "https://sofialuz.net/Login/icons8-marcador-b-50.png";
              }else if(estado_usuario=="Ocupado"){
  ...
  const contentString =
                          ...
                          '</center>'+
                          '<div id="bodyContent">' +
                          "<p><b>Estado:" + estado_usuario + "</p>" +
                          "<p><b>Último Reporte:" + horareporte + "</p>" +
                          "</p>" +
                          "</div>" +
                          "</div>";
