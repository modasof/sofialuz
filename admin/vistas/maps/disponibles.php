...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Conductores Disponibles (GPS)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
 ...
 <div class="col-md-12">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="?controller=maps&&action=disponibles">Ver Disponibles</a></li>
             <li class="breadcrumb-item active"><a href="?controller=maps&&action=ocupados">No Disponibles</a></li>
          </ol>
        </div><!-- /.col -->
...
transitLayer.setMap(map);
          ...
          downloadUrl('https://sofialuz.net/admin/vistas/maps/xml_1.php', function(data) {
