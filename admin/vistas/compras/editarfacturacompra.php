...
<td id="valorivafinal">
    ...
    <input type="hidden" id='campoiva' class="claseiva input-sm" value="<?php echo ($fac_valor_iva); ?>" name="valor_iva_txt">
</td>
</tr>
<tr>
<th>
 ...
 $(document).ready(function(){
    ...
    $( "#calculopago" ).click(function() {
        ...
        var v3 = v1.replaceAll("$", "");
         ...
         var calculototal=parseFloat(subtotal)+parseFloat(iva3)-parseFloat(r3)-parseFloat(ra3)-parseFloat(v3);
