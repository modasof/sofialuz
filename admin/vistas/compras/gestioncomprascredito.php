...
?>
    ...
    <td>
        ...
        <i data-toggle="tooltip" data-placement="left" title="Indica el valor de las retenciones aplicadas" class="fa fa-question-circle"></i>
         ...
         <a href="?controller=compras&action=cambiarestadocreditos&des=<?php echo($itemsget); ?>&&id=<?php echo($idreq); ?>" id="menosretencion<?php echo($despachounico);?>" class="btn-success btn-xs"><i class="fa fa-minus"></i></a>
    <br>
    ...
    <a href="?controller=compras&action=cambiarestadocreditos&des=<?php echo($itemsget); ?>&&id=<?php echo($idreq); ?>" id="masiva<?php echo($despachounico);?>" class="btn-danger btn-xs"><i class="fa fa-plus"></i></a>
