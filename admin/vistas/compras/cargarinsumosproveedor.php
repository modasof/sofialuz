...
$getproveedor=$_GET['idproveedor'];
$getnomproveedor=Proveedores::obtenerNombreProveedor($getproveedor);
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="?controller=compras&&action=todospormes">Compras Total</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
                          <div class="row">
        <form action="?controller=compras&&action=porfechainsumospro&&idproveedor=<?php echo($getproveedor); ?>" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
if ($fechaform != "") {
    ?>
           <h3 class="m-0 text-dark">Reporte Compras Insumos/Servicios del <?php echo (fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?>Proveedor <?php echo($getnomproveedor) ?></h3>
          <?php
} else {
    ?>
           <h3 class="m-0 text-dark">Reporte Compras Insumos/Servicios proveedor <?php echo($getnomproveedor); ?></h3>
          <?php
}
...
echo ($fechaform);
if ($fechaform != "") {
    $res    = Compras::porfechacargarinsumospro($FechaStart, $FechaEnd,$getproveedor);
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
              ...
              <td><a href="vistas/compras/cotizaciones_print.php?id=<?php echo ($proveedor_id_proveedor); ?>&&idcompra=<?php echo ($ordencompra_num); ?>" target="_blank" class="btn btn-default"><?php echo ($ordencompra_num."-Fac.".$id_factura) ?> </a> </td>
